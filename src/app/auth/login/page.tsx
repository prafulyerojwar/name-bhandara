...
import { loginUser, signInWithGoogle, resetPassword, friendlyAuthError } from '@/lib/auth';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-amber-50 to-red-50 mandala-bg px-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <span className="absolute bottom-20 right-10 text-4xl animate-float-delay opacity-20">🍛</span>
      </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-orange-100">
          ...
          <div className="bg-gradient-to-r from-orange-500 to-red-500 px-8 py-8 text-white text-center">
            ...
            <p className="text-orange-100 text-sm mt-1">
              {view === 'login' ? 'अन्नदान महादान | Food is God\'s blessing' : 'We\'ll send a reset link to your email'}
            </p>
          </div>
              ...
              >
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3.5 bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                  >
            ...
            {view === 'forgot' && (
              ...
              >
                <p className="text-sm text-stone-600 leading-relaxed">
                  Enter the email address you registered with. We'll send you a link to set a new password.
                </p>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 text-sm text-stone-500 hover:text-orange-600 transition-colors"
                >
